...
d25 4
a28 4
const Fatal_Timeout  = 5*60; // 5 minutes
const SEOF_Timeout   = 10;   // 10 seconds
const SStop_Timeout  = 10;   // 10 seconds
const Wakeup_Timeout = 2;    // 2 seconds
@
...
d92 1
a92 1
  Receiver sends Ack each time it got something correctly. If 
d95 19
a113 1
  up as it's lower side received correctly.
@
