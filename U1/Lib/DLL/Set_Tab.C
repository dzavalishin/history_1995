...
// REXX
    ...
    { "Rexx.Kick.uucp",	     &conf.rexx_kick_uucp,	    0, BString,	NULL,				  NotRequired    },
    ...
    { "UseFrip",             &conf.enable_frip,             0, BBool,   NULL,                 NotRequired },
...
// ? FlagDir unused now?
    ...
    { "RecodeDir",	     &conf.recode_dir,		    0, BString, NULL,                 NotRequired },
    ...
    { "Debug",               &conf.log_debug,               0, BBool,   NULL,                 NotRequired },
...
//  { "IGNORENAME",	     NULL,		            0, BNone,   add_ignname,          NotRequired },
    ...
    { "BatchMailSpool",      &conf.batchmail_spool,         0, BString, NULL,                 NotRequired },
...
static void strip_trailsp( char *p )
    {
    char	*lastch = p;
...
set_uucp_type( char *t )
	...
	if( !stricmp( t, "WAFFLE" ) )
        ...
        if( !stricmp( t, "SENDMAIL" ) )
		{
		conf.uucp = UUCP_Sendmail;
		return Ok;
		}
