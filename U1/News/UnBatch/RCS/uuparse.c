...
1.4
date	95.08.02.13.46.47;	author dz;	state Exp;
branches;
next	1.3;
...
@d7 4
a10 1
 *      $Log:   Q:/news/unbatch/vcs/uuparse.c_v  $
d100 1
a100 1
...
d306 1
a306 1
	if( !strncmpi( hl, "Control:", 8 ))
d309 1
a309 1
	if( !strncmpi( hl, "X-Batch:", 8 ))
d312 1
a312 1
	if( !strncmpi( hl, "Message-ID:", 11 ))
d315 1
a315 1
