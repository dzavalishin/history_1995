...
1.1
date	95.05.08.23.32.22;	author dz;	state Exp;
branches;
next	;
...
$(M_OUT)\feeds.U1 $(M_OUT)\batch.exe $(M_OUT)\snews.exe $(DLLP) \
$(M_OUT)\gremote.exe 
...
$(AR_DIR)\$(AR_FILE): $(U1_LIST)
        -del /q $(AR_DIR)\$(AR_FILE)
	echo U1 Version $(VER) - alpha release >$(MMTMP)
        $(ZIP) -z $(AR_DIR)\$(AR_FILE) $(U1_LIST) hot.txt <$(MMTMP)
	-del $(MMTMP)
...
d103 2
a104 1
   $(HATCH) $(AR_DIR)\$(AR_FILE) UU2 "U1 $(VER) Alpha"
d119 4
a122 1
   $(HATCH) $(BR_DIR)\$(BR_FILE) UU2 "U1 $(VER) Beta"
d162 1
a162 1
...
d279 1
a279 1
# $(M_OUT)\gremote.exe $(M_OUT)\uustat.exe $(M_OUT)\U1.doc $(M_OUT)\worlds.doc $(M_OUT)\setup.doc
d283 1
a283 9
$(HOT_DIR)\$(HOT_FILE): $(U1_LIST)
        del /q    $(HOT_DIR)\$(HOT_FILE)
...
d291 3
a293 1
        $(ZIP)  $(AR_DIR)\$(AR_FILE) $(U1_LIST) hot.txt
d298 3
a300 1
        $(ZIP)  $(AR_DIR)\$(AR_DOX) $(U1_DOX_LIST) history hot.txt
d309 21
a329 1
        $(ZIP)  $(BR_DIR)\$(BR_FILE) $(U1_LIST) $(U1_DOX_LIST)
@
