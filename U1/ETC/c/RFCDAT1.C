─ REL.SOURCES (2:5020/23.77@fidonet.org) ───────────────────────── REL.SOURCES ─
 ...
 Subj : (1) [src] Более толерантный преобразователь даты (RFC 1036)             
────────────────────────────────────────────────────────────────────────────────
...
# define ERROR  -32000          /* код ошибки для getword */
...
─ REL.SOURCES (2:5020/23.77@fidonet.org) ───────────────────────── REL.SOURCES ─
 ...
 From : vak@relcom.kiae.su          2:5020/23               Wed 13 May 92 18:26 
 To   : All                                                 Thu 14 May 92 02:14 
 Subj : (2) [src] Более толерантный преобразователь даты (RFC 1036)             
────────────────────────────────────────────────────────────────────────────────
 * Real name: Serge V.Vakulenko
...
/*
 * Hазвания дней недели для печати.
 */
static char *dayname [] = {
...
─ REL.SOURCES (2:5020/23.77@fidonet.org) ───────────────────────── REL.SOURCES ─
 ...
 From : vak@relcom.kiae.su          2:5020/23               Wed 13 May 92 18:26 
 To   : All                                                 Thu 14 May 92 02:14 
 Subj : (3) [src] Более толерантный преобразователь даты (RFC 1036)             
────────────────────────────────────────────────────────────────────────────────
 * Real name: Serge V.Vakulenko
