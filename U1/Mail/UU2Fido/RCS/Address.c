...
1.3
date	95.08.02.13.04.48;	author dz;	state Exp;
branches;
next	1.2;

1.2
date	95.08.02.12.58.56;	author dz;	state Exp;
branches;
next	1.1;
...
@d8 2
a9 2
 *      Revision 1.2  1995/08/02 12:58:56  dz
 *      cosmetical
d11 2
a12 2
 * Revision 1.1  1995/03/07  00:20:29  dz
...
@d7 4
a10 1
 *      $Log:   Q:/uu2fido/vcs/address.c_v  $
d58 2
d83 1
a83 1
remap_addr( fido_user &fto, const char *to_a )
d87 7
d177 1
d195 1
@
